...
function MOI.get(sampler::Sampler, attr::Union{MOI_ATTRIBUTES, AbstractSamplerAttribute}, value)
    sampler.attrs[attr] = value
end

function MOI.set(sampler::Sampler, attr::MOI.RawOptimizerAttribute, value)
